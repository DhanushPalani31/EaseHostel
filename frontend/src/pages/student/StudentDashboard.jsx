...
import { ShoppingBag, Clock, Heart, ArrowRight, Package, TrendingUp, PackagePlus, Truck } from 'lucide-react';
...
const QUICK_LINKS = [
  ...
  { to: '/custom-orders',  icon: PackagePlus, label: 'Custom Order',  desc: 'Request anything' },
  { to: '/parcel-request', icon: Truck,       label: 'Parcel Pickup', desc: 'Amazon / Flipkart' },
